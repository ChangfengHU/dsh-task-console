...
- Routed Stage 5/6/7/8/10 through an HTTPS-only Cloud Workflow transport whose POST body has exactly schema, operation id, stage and IP. Stage 1/3/4/9 remain fresh probe gates.
...
- Refreshed the managed Skill lock to linux-clash-skill commit `ba28df1453783f46968dcafc6ec99048f4e06573`; machine-local Python bytecode/cache files are excluded from copies and content hashes.
