        ...
        return (definition) => {
          ...
          return target.register({
            ...
            execute(args, exec) {
              ...
              if (rawName.replace(/-/g, "_") === "vyibc_wecom_send_message" && String(exec?.agent?.session?.id ?? "").startsWith("task-") && exec?.parent?.name !== "task_notify") throw new Error("Task notifications must use task_notify with reviewed recipients and durable deduplication");
