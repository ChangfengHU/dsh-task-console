...
async function fleetActionOptions(config, p, values, load) {
  ...
  if (p.source === "fleet.nodes") {
    ...
    return { items: inventory.nodes.filter((n) => n.ip && n.readAuthorized).map((n) => ({ value: n.ip, label: n.ip, detail: `${n.nodeId} \xB7 ${n.reachable ? "\u5728\u7EBF" : "\u4E0D\u53EF\u8FBE"} \xB7 \u6D4F\u89C8\u5668 ${n.browsers.length}` })), notice: "\u53EA\u8BFB\u540D\u518C\uFF1B\u4E5F\u53EF\u624B\u586B\u65B0\u673A\u5668 IP\u3002\u9009\u62E9\u4E0D\u4EE3\u8868\u5DF2\u6709\u64CD\u4F5C\u6743\u9650\u3002" };
  }
