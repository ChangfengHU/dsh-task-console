...
\u6267\u884C\u5339\u914D\u4EFB\u52A1\u524D\u4F7F\u7528 skill \u5DE5\u5177\u52A0\u8F7D\u5B8C\u6574\u8BF4\u660E\uFF1B\u76EE\u5F55\u4E0D\u662F\u6388\u6743\u7ED5\u8FC7\u5176\u4ED6\u5DE5\u5177\u9650\u5236\u3002` }] }];
  ...
  async describe(agent, exposed) {
    ...
    const tools = schemas.map((s) => ({ name: s.name, kind: s.name.startsWith("mcp__") ? "mcp" : "native", source: CAPABILITY_TOOLS.includes(s.name) ? "platform" : declared.has(s.name) ? "agent-definition" : "environment-inherited", state: availableNames.has(s.name) ? "registered" : "restricted", ...this.restricted(s, agent) ? { reason: "explicit-standard-exclusion" } : {}, ...errors.has(s.name) ? { lastFailure: errors.get(s.name) } : {} }));
    const out = {
