...
function cardMessage(task, card, batchId, upstream) {
  ...
  if (task.design?.evidenceContract === "browser-patrol-v2") lines.push(
    ...
    card.role === "executor" ? '\u4F60\u53EA\u5B8C\u6210\u672C\u8F6E\u51BB\u7ED3 items \u7684\u52A8\u4F5C\uFF0C\u53D6\u5F97\u540E\u53F0\u64CD\u4F5C\u7EC8\u6001\u540E\u7ACB\u5373 task_complete({summary:"\u771F\u5B9E\u7ED3\u679C\u53CA\u4E0B\u6E38\u5F85\u9A8C\u9879"}) \u4EA4\u7ED9\u8BC4\u4F30\u8005\u3002\u4E0D\u5F97 task_wait \u7B49\u5F85\u4E0B\u6E38\u91C7\u6837\uFF0C\u4E5F\u4E0D\u5F97\u4E3A\u586B\u6EE1\u72EC\u7ACB\u91C7\u6837\u91CD\u590D provision\u3002' : card.role === "reviewer" ? "\u53EA\u6709\u4F60\u8D1F\u8D23\u5206\u65F6\u72EC\u7ACB\u590D\u9A8C\u5E76\u53EF task_wait\u3002\u65B0\u9C9C\u63A2\u9488\u624D\u7B97\u65B0\u91C7\u6837\uFF1B\u7F13\u5B58/\u91CD\u590D\u56DE\u6267\u4E0D\u7B97\u3002\u4F18\u5148\u68C0\u67E5\u672C\u8F6E\u4FEE\u590D\u76EE\u6807\uFF0C\u7B49\u5F85 observation.nextCheckAt\uFF0C\u4FEE\u590D\u540E\u4ECD\u987B\u5B8C\u6574\u89C2\u5BDF\u7A97\u53E3\uFF1B\u5065\u5EB7\u76EE\u6807\u53D6\u5F97\u672C\u8F6E\u72EC\u7ACB\u68C0\u67E5\u540E\u4E0D\u56E0\u5176\u56DE\u6267\u5728\u4EA4\u63A5\u4E2D\u5230\u671F\u800C\u91CD\u505A\u68C0\u67E5\u621620\u5206\u949F\u89C2\u5BDF\u3002\u660E\u786E\u4ECD\u672A\u767B\u5F55/\u6311\u6218\u65F6\u4EA4\u63A5\u8FD4\u5DE5\u7ED3\u8BBA\uFF0C\u4E0D\u7A7A\u7B49\u51D1\u7A33\u5B9A\u6837\u672C\u3002\u5F97\u5230\u901A\u8FC7\u6216\u8FD4\u5DE5\u7ED3\u8BBA\u540E task_complete \u4EA4\u7ED9\u89C4\u5212\u8005\u3002" : "\u5148\u901A\u8FC7 task_notify \u7559\u4E0B\u901A\u77E5\u56DE\u6267\uFF1B\u6839\u636E\u771F\u5B9E\u8BC1\u636E task_plan_round \u6216 task_finalize\u3002\u4E0D\u8981 task_wait \u7B49\u5F85\u5C1A\u672A\u6267\u884C\u7684\u4E0B\u6E38\uFF1B\u901A\u77E5\u5931\u8D25\u53EA\u5904\u7406\u901A\u77E5\uFF0C\u4E0D\u80FD\u91CD\u8DD1\u5DF2\u5B8C\u6210\u6D4F\u89C8\u5668\u52A8\u4F5C\u3002"
  );
...
var BrowserPatrolWorkflow = class {
  ...
  status(input, now = Date.now()) {
    ...
    return {
      ...
      items,
      uncovered,
      ...patrolReportSummary(items, uncovered)
    };
  }
  complete(input) {
