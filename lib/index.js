...
function createEnvelope(payload, version, now = /* @__PURE__ */ new Date()) {
  const normalized = {
...
function parseEnvelope(raw) {
  ...
  return { schema: CONFIG_SCHEMA, exportedAt: new Date(e.exportedAt).toISOString(), source: { plugin: "dsh-task-console", version: text2(e.source.version, "\u7248\u672C", 80) }, digest: e.digest, payload };
}
