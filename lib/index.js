...
function browserPatrolEvidence(input, events) {
  ...
  for (const e of events) {
    if (e.type === "tool/call") {
      const name2 = /^mcp__fleet-browser(?:-browser-manager)?__(browser_fleet_inventory|browser_inspect)$/.exec(e.data.name)?.[1];
      if (!name2) continue;
      try {
  ...
  for (const node of inventory.nodes) {
    ...
    for (const browser of node.browsers) {
      const check = inspections.get(node.ip), actual = check?.browsers.find((b) => b.instance === browser.instance);
...
${detail}
\u5DE1\u67E5\u8BC1\u636E\u4E0D\u5B8C\u6574\uFF0C\u4E0D\u80FD\u7EFF\u8272\u4EA4\u5377\u3002\u8865\u767B\u5F55\u7EC8\u6001\u540E\u987B\u53EA\u8BFB inspect \u7559\u4E0B\u5B9E\u9645\u7ED3\u679C\uFF1B\u672A\u77E5\u4E0D\u80FD\u590D\u5236\u3002\u5176\u4F59\u72EC\u7ACB\u76EE\u6807\u6536\u53E3\u540E task_block(kind=capability)\uFF0C\u4E0D\u8981\u6C42\u7528\u6237\u91CD\u590D\u6388\u4E88\u5DF2\u6709\u6743\u9650\u3002` : void 0
  };
}
