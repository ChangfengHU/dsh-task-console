...
BASE = 'https://dsh-152-32-214-95.vyibc.com/?v=0.31.1'
with sync_playwright() as p:
    ...
    for width in (1440, 390):
        ...
        page.goto(BASE + '#/tc/agents', wait_until='domcontentloaded', timeout=60000)
        entry = page.get_by_role('button', name='导入 / 导出', exact=True)
