...
export const STUDIO_TOOL_NAMES=['studio_register_stage','studio_status','studio_register_candidate','studio_read_text','studio_inspect_frames','studio_inspect_probe','studio_inspect_audio','studio_submit_review','studio_reference_frames','studio_reference_audio','studio_character_image','studio_preview_audio','studio_preview_image','studio_preview_frames'] as const
